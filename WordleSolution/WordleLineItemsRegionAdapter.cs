...
namespace Wordle
{
    internal class WordleLinesRegionAdapter : RegionAdapterBase<WordleLines>
    {
        public WordleLinesRegionAdapter(IRegionBehaviorFactory regionBehaviorFactory) : base(regionBehaviorFactory)
        {

        }


        protected override void Adapt(IRegion region, WordleLines regionTarget)
        {
